...
export default function DataTable() {
    ...
    renderCell: (params) => (
      <>
        <Button
          ...
          onClick={async () => {
            Swal.fire({
              title: "Are you sure you want to delete your data client?",
              icon: "info",
        ...
        <Button
          ...
          onClick={() => {
            Swal.fire({
              title: "Are you sure you want to update your data client?",
              icon: "info",
              showDenyButton: true,
  ...
  return (
    <div style={{ height: '80%', width: '100%' }}>
      ...
      <Button variant="outlined" color='info' sx={{my:3,mx:10}}>Create Charge</Button>
      </Link>
      <DataGrid
        autoHeight
